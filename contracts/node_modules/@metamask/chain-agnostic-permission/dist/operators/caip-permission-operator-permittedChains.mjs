 ...
 */
export function getAllNamespacesFromCaip25CaveatValue(caip25CaveatValue) {
 ...
 */
export const setChainIdsInCaip25CaveatValue = (caip25CaveatValue, chainIds) => {
...
//# sourceMappingURL=caip-permission-operator-permittedChains.mjs.map