 ...
 */
export declare const getSessionScopes: (caip25CaveatValue: Pick<Caip25CaveatValue, 'requiredScopes' | 'optionalScopes'>, { getNonEvmSupportedMethods, sortAccountIdsByLastSelected, }: {
    getNonEvmSupportedMethods: (scope: CaipChainId) => string[];
    sortAccountIdsByLastSelected?: ((accounts: CaipAccountId[]) => CaipAccountId[]) | undefined;
...
//# sourceMappingURL=caip-permission-operator-session-scopes.d.cts.map