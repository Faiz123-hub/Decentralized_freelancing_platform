import { Hex as Hex$1 } from '@metamask/utils';
 ...
 */
declare const getInfuraRpcUrls: ({ infuraApiKey, chainIds, }: {
    infuraApiKey: string;
    chainIds?: Hex$1[];
}) => Record<Hex$1, string>;
 ...
 */
declare class EIP1193Provider extends EventEmitter<EIP1193ProviderEvents> {
    #private;
    ...
    set selectedChainId(chainId: Hex | undefined);
    /**
...
type ConnectEvmStatus = 'disconnected' | 'connected' | 'connecting';
/**
 ...
 * ```
 */
declare class MetamaskConnectEVM {
    #private;
    /**
