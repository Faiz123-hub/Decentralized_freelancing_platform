...
export class MWPTransport {
    ...
    disconnect() {
        return __awaiter(this, arguments, void 0, function* (scopes = []) {
            ...
            const cachedSessionScopes = (_b = (_a = cachedSession === null || cachedSession === void 0 ? void 0 : cachedSession.result) === null || _a === void 0 ? void 0 : _a.sessionScopes) !== null && _b !== void 0 ? _b : {};
