...
exports.BUILT_IN_NETWORKS = {
    ...
    [types_1.NetworkType['base-mainnet']]: {
        chainId: types_1.ChainId['base-mainnet'],
        ticker: types_1.NetworksTicker['base-mainnet'],
        rpcPrefs: {
            blockExplorerUrl: types_1.BlockExplorerUrl['base-mainnet'],
        },
    },
